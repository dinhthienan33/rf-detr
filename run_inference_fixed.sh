...
# For Windows paths, use forward slashes or set via environment variable
...
# If you have a video, extract a frame first
...
# This handles paths like D:\path\to\file -> /d/path/to/file or D:/path/to/file
if [[ "$OSTYPE" == "msys" || "$OSTYPE" == "cygwin" ]]; then
    # Convert Windows drive letters to Unix format (D: -> /d)
